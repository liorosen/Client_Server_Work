...
//                            String fileName = new String(Arrays.copyOfRange(bytes, 2, len), StandardCharsets.UTF_8);
//                            byte[] packetData = new byte[2 + fileName.length() + 1]; // Opcode (2 bytes) + filename bytes + null terminator
//                            packetData[0] = 0; // Most significant byte of opcode
//                            packetData[1] = 1; // Least significant byte of opcode
